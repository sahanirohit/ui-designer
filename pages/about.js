    ...
    <div className="px-6 py-16 bg-orange-50 lg:px-28 ">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center w-full justify-center ">
          <div className="flex flex-col md:flex-row justify-center w-full gap-16">
            <div className="flex flex-col space-y-4">
              ...
              <p className="max-w-md">
                User experience and user interface design are all about
                listening to your target audience and translating their desires
                into features that satisfy a need.
              </p>
              <p className="max-w-md">
                Brand website design is not just about pleasing aesthetics, but
                also about creating an ideal user experience. We believe that
                the priorities should be focused on people, not the product.⁣⁣
              </p>
              <p className="max-w-md">
                A great user experience never goes without a great web design,
                so discover how #brandname can help
              </p>
        ...
        <div className="pt-16 flex lg:flex-row flex-col gap-4 overflow-hidden">
          ...
          <div className="basis-3/4 overflow-hidden scroll-smooth slides gap-4 flex w-full max-h-[300px] h-80">
